...
export default function Hero() {
  return (
    <div className={styles["page-root"]}>
      ...
      <nav className={styles.nav}>
        <div className={styles["nav-inner"]}>
          <div className={styles.brand}>
            <span className={styles.dot} /> Edouard <span className={styles.role}>/ dev</span>
          </div>
      ...
      {/* Le wrapper et la classe 'scaled' ne feront effet que < 1440×810 */}
      <div className={styles.scaleWrap}>
        <section className={`${styles["desktop-1"]} ${styles.scaled}`}>
          {/* Nom */}
          ...
          {/* Rôle */}
          <div className={styles["dveloppeur-web-container"]} style={{ fontWeight: 700 }}>
